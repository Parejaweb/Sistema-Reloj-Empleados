...
<body class="hold-transition lockscreen" onload="FocusOnInput()">
...
<div class="lockscreen-logo">
	<a href="#"><b></d>Corporación Tecnológica de Bogotá C.T.B</a>
	</div>
  <!-- User name -->
  ...
  <div class="lockscreen-item">
    ...
    <form  action="" class="lockscreen-credentials" name="formulario" id="formulario" method="POST">
      <div class="input-group">
        <input type="password" class="form-control" name="codigo_persona" id="codigo_persona" placeholder="ID de Empleado CTB">
  ...
  <div class="help-block text-center">
    DIGITE SU IDENTIFICACION O ESCANE SU CARNET
  </div>
  <div class="text-center">

  </div>
  <div class="lockscreen-footer text-center">
	    <a href="../admin/">GRACIAS</a>
  </div>
</div>
<!-- /.center -->
