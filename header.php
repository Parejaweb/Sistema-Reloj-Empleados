...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="logo-mini"><b>C.T.B</b> A</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>C.T.B</b> ADMIN</span>
    </a>
...
-->
      ...
      <li><a href="https://www.ctb.edu.co/"><i class="fa  fa-exclamation-circle"></i> <span>Acerca de</span><small class="label pull-right bg-yellow">ComCod</small></a></li>   
